...
namespace App\ControllersTipoOcorrencia;
...
use App\Controllers\TipoOcorrencia\DbController;
...
class ApiController extends ResourceController
{
    ...
    public function __construct()
    {
        ...
        $this->DbController = new TipoOcorrenciaDbController();
    ...
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function dbRead_($parameter = NULL)
    {
        $request = service('request');
        $apiRespond['getMethod'] = $request->getMethod();
        $apiRespond['method'] = __METHOD__;
