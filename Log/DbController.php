...
use App\Controllers\Pattern\BaseController;
use App\Controllers\Pattern\MessageController;
use App\Models\LogModel;
# use App\Models\VLogModelModels;
use Exception;
...
class DbController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->pagination = new BaseController();
        $this->message = new MessageController();
        $this->ModelLog = new LogModel();
        // $this->ModelUpload = new UploadModel();
        // $this->ModelVTabelaPrincipal = new VLogModelModels();
    }
