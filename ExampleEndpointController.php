...
class ExampleEndpointController extends ResourceController
{
    ...
    private $template = 'novodeposito/templates/main';
    ...
    // Consumo de API
    // route GET /www/sigla/rota/(:any)
    // route POST /www/sigla/rota/(:any)
    // Informação sobre o controller
    // retorno do controller [VIEW]
    public function displayAPI($parameter = NULL)
    {
        ...
        //
        exit('displayAPI - src\app\Controllers\ExampleEndpointController.php');
        $loadView = array(
            $this->head,
            $this->menu,
            $this->message,
    ...
    public function reactSelect($parameter = NULL)
    {
        ...
        $loadView = array(
            ...
            'exemplo/principal/input_select',
            $this->footer,
        );
        try {
            // URI da API
