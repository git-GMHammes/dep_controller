...
use App\Models\TabelaModels;
use App\Models\VTabelaModels;
use Exception;

class ExampleDbController extends BaseController
{
    // private $ModelUpload;
    private $ModelVTabela;
    ...
    public function __construct()
    {
        ...
        $this->ModelVTabela = new VTabelaModels();
        $this->pagination = new SystemBaseController();
        $this->message = new SystemMessageController();
        $this->ModelCadastro = new TabelaModels();
    ...
    public function dbFields($processRequestFields = array())
    {
        ...
        if ($dbCreate == array()) {
            (isset($processRequestFields['submit_fild'])) ? ($dbCreate['dbField'] = $processRequestFields['submit_fild']) : (NULL);
        }
    ...
    public function dbFieldsFilter($processRequestFields = array())
    {
        // myPrint($processRequestFields, 'src\app\Controllers\SystemUploadDbController.php', true);
        $dbCreate = array();
        $autoColumn = $this->ModelVTabela->getColumnsFromTable();
