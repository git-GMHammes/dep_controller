...
class DbController extends BaseController
{
    ...
    public function dbFields($processRequestFields = array())
    {
        ...
        $dbCreate = array();
        $autoColumn = $this->ModelCliente->getColumnsFromTable();
    ...
    public function dbCreate($parameter = NULL)
    {
        ...
        try {
            $this->ModelCliente->dbCreate($this->dbFields($parameter));
            $affectedRows = $this->ModelCliente->affectedRows();
            if ($affectedRows > 0) {
                $dbCreate['insertID'] = $this->ModelCliente->insertID();
    ...
    public function dbUpdate($key, $parameter = NULL)
    {
        if (
            ...
            $this->ModelCliente->dbUpdate($key, $parameter);
        } else {
            $this->ModelCliente->dbUpdate($key, $this->dbFields($parameter));
        }
        try {
            $affectedRows = $this->ModelCliente->affectedRows();
            if ($affectedRows > 0) {
    ...
    {
        try {
            $this->ModelCliente->dbDelete('id', $parameter);
            $affectedRows = $this->ModelCliente->affectedRows();
            if ($affectedRows > 0) {
