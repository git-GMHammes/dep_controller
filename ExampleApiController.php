...
use App\Controllers\ExampleDbController;
...
class ExampleApiController extends ResourceController
{
    ...
    {
        $this->DbController = new ExampleDbController();
    ...
    public function dbRead($parameter = NULL)
    {
        ...
        #
        // myPrint($getMethod, 'src\app\Controllers\ModeloApiController.php');
        try {
            #
    ...
    # route POST /# www/exemple/group/api/filtrar/(:any)
    # route GET /# www/exemple/group/api/filtrar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function dbFilter($parameter = NULL)
    {
        ...
        try {
            ...
            // myPrint($processRequest, 'src\app\Controllers\ModeloApiController.php');
            $requestDb = $this->DbController->dbFilter($processRequest, $page);
            // myPrint($requestDb, 'src\app\Controllers\ModeloApiController.php', true);
            #
            $apiRespond = [
                'status' => 'success',
                'message' => 'API loading data (dados para carregamento da API)',
    ...
    public function create_update($parameter = NULL)
    {
        ...
        if ($choice_update === true) {
            if ($this->tokenCsrf->valid_token_csrf($token_csrf)) {
                ...
                myPrint('Você esqueceu o Token', 'src\app\Controllers\UnidDisponibilidadeApiController.php');
            }
    ...
    # route POST /www/exemple/group/api/deletar/(:any)
    # route GET /www/exemple/group/api/deletar/(:any)
    # Informação sobre o controller
    # retorno do controller [JSON]
    public function dbDelete($parameter1 = NULL, $parameter2 = NULL)
    {
        ...
        try {
            ...
            if (
                ...
                myPrint($parameter1, 'src\app\Controllers\ModeloApiController.php, 302', true);
